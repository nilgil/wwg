...
<link defer rel='stylesheet' media='screen'
	href='/css/comm/meetview.css'>
	...
	<div class="c_meetview_center">
		...
		<div class="side">
			<table id="side_menu" class="table table-hover">
				...
				<tbody>
					<tr>
						<td><a href="/noticelist">공지사항</a></td>
					</tr>
					<tr>
						<td><a href="/reviewlist">여행후기</a></td>
					</tr>
					<tr>
						<td><a href="/meetlist">동행구해요</a></td>
					</tr>
				</tbody>
			</table>
		</div>
