...
<body>
    ...
    <nav class="navbar">
		...
		<div class="navbar_logo">
			<a href="mainPage.html"><img src="../img/제주도로고2 copy.png">
				혼저옵서예</a>
		</div>
		...
		<ul class="navbar_menu">
			...
			<li>
				<div class="dropdown">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">숙소</a> <a class="dropdown-item"
							href="#">맛집</a> <a class="dropdown-item" href="#">여행지</a>
					</div>
				</div>
			</li>
				...
				<div class="dropdown">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">공지사항</a> <a
							class="dropdown-item" href="#">여행후기</a> <a class="dropdown-item"
							href="#">동행구해요</a>
					</div>
				</div>
			</li>
			...
			<li>
				<div class="dropdown">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">계획짜기</a> <a
							class="dropdown-item" href="#">계획게시판</a>
					</div>
				</div>
			</li>
		...
		<ul class="navbar_search" action="/action_page.php">
			<li><input class="form-control mr-sm-2" type="text"
				placeholder="애월 카페" title="검색어입력"></li>
