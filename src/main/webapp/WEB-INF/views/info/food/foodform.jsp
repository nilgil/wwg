...
<table id="foodform_table1" class="table table-hover" width=900 align=center>
	...
	<tr><th>제목</th>
		<td><input type=text name="food_title" required="required" size="60" maxlength="29" placeholder="제목(최대 29자)"></td>
	</tr>
	<tr><th>내용</th>
		<td><textarea rows="25" cols="70" id="content" name="food_content" maxlength="284" placeholder="내용(최대 284자)"></textarea>
